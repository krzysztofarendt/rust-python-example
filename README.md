# Example of a mixed Rust/Python project

## Introduction

This is an example of how to setup a project with a Python package with an
...
uv init --build-backed maturin mypackage
uvx maturin develop
uv sync
```
